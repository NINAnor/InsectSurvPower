...
#' @param host Name of database server. Defaults to (new) main PostgreSQL machine "ninpgsql03.nina.no".
#'
#' @import DBI
#' @import RPostgres
#' @export

postgresConnect <- function(Username = "postgjest", Password = "gjestpost", host = "ninpgsql03.nina.no"){
