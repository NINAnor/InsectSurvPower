...
```{r calc_predOccs, eval = F, include = F}
...
```
```{r osloKommune, fig.cap = "Included kommunes in Oslo area calculation"}
...
```{r bergenKommune, fig.cap = "Included kommunes in Bergen area calculation"}
...
```{r trondheimKommune,  fig.cap = "Included kommunes in Trondheim area calculation"}
...
```{r stavangerKommune,  fig.cap = "Included kommunes in Stavanger area calculation"}
...
Run calculations
```{r run_survey_calc, include = F, eval = F}
...
```{r stavanger_calc, eval = F, include = F}
...
```{r run_survey_calc6years, eval = F, include = F}
...
```{r stavanger6years, eval = F, include = F}
...
```{r surTab6years, results = "asis", echo = F}
...
```{r run_survey_calc3years, eval = F, include = F}
...
```{r stavanger3years, eval = F, include = F}
...
```{r surTab3years, results = "asis", echo = F}
...
```{r calcLocationsNeeded, include = F, eval = F}
...
<!-- ```{r} -->
<!-- lowDetectDf <- obsProb(occProb = 0.01, -->
<!--                     detectProb = 0.05, -->
<!--                     locations = seq(200, 1000, by = 200), -->
<!--                     visits =  1, -->
<!--                     visitCost = 5000) -->
