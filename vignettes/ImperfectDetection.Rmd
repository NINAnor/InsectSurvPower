...
```{r calcLocationsNeeded, eval = T}

norgeDet0.426Vis1 <- weightedDetection(occWeights = occWeights,
                  visWeights = occWeights,
                  noOccur = 500,
                  noLocations = seq(50, 1000, by = 50),
                  detectProb = 0.426/16,
                  nIter = 999,
                  noVisits = 1)
...
save(norgeDet0.426Vis1, norgeDet0.426Vis4, norgeDet0.426Vis10, norgeDet0.639Vis1, norgeDet0.639Vis4, norgeDet0.639Vis01, file = "neededLocEmp.Rdata")
```
```{r}
